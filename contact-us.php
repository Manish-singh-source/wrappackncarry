			...
			<div class="row g-0">
				...
				<div class="col-md-12 col-xl-7">
					<div class="contact-form-area pbmit-bg-color-white">
						...
						<form class="contact-form" method="post" id="contact-form" action="submit-contact" onsubmit="if(this.checkValidity()){this.querySelector('button').disabled=true;} return true;">
							...
							<div class="row">
								...
								<div class="g-recaptcha mb-3" data-sitekey="6LeDZuYsAAAAAE7j-RvrkOXS488u4LzPft0iFkAl"></div>
								<div class="col-md-12">
