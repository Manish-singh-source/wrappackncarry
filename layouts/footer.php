...
<footer class="site-footer">
    <div class="pbmit-footer-overlay-area pbmit-bg-color-global">
        <div class="container">
            <div class="row">
                ...
                <div class="row align-items-center">
                    <div class="col-md-12 col-xl-4">
                        <div class="pbmit-footer-logo">
                            <img src="images/wrap-logo.png" class="pbmit-main-logo" alt="">
                        </div>
                    </div>
                    <div class="col-md-12 col-xl-8 pbmit-footer-right">
                        <h3 class="pbmit-title">Sustainable food packaging designed to protect <br> your products while caring for the environment.</h3>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <aside class="widget widget_text">
                        <div class="textwidget">
                            <div class="pbmit-footer-text">
                                Modern, sustainable packaging crafted to enhance your food presentation and brand value.
                            </div>
                    ...
                    <div class="widget widget2">
                        ...
                        <!-- <div class="pbmit-timelist-wrapper">
                            <ul class="pbmit-timelist-list">
                                ...
                                <li><span class="pbmit-timelist-li-title">Saturday: 10.00am - 5.00pm</span></li>
    ...
    <div class="pbmit-footer-text-area">
        <div class="container">
            <div class="pbmit-footer-text-inner">
                <div class="row">
                    <div class="col-md-6">
                        <div class="pbmit-footer-copyright-text-area">© <script>
                                document.write(new Date().getFullYear());
                            </script> <strong>Wrap Pack N Carry </strong> | All Rights Reserved.</div>
    ...
    <!-- <div class="footer-right-img">
				<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSk_kH_YEgsqNF934cOc3wr4tjKa55bG2PbcQ&s" alt="">
			</div> -->
</footer>
<!-- footer End -->
    ...
    (function() {
        function c() {
            ...
            if (b) {
                ...
                d.innerHTML = "window.__CF$cv$params={r:'9e44a40d7f4e446e',t:'MTc3NDg0Nzc3MQ=='};var a=document.createElement('script');a.src='../cdn-cgi/challenge-platform/h/g/scripts/jsd/ea2d291c0fdc/maind41d.js';document.getElementsByTagName('head')[0].appendChild(a);";
