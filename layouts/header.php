...
<head>
    ...
    <title>Wrap Pack N Carry - <?php echo $title ?? ''; ?> </title>
    <meta name="robots" content="noindex, follow">
    <meta name="description" content="WrapPackNCarry offers eco-friendly food packaging solutions including wrapping paper, food contact paper, packaging rolls, and sustainable products for restaurants and businesses.">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="images/wrap-logo-fevicon.png">
    <!-- CSS
         ============================================ -->
    <!-- Bootstrap CSS -->
        ...
        <header class="site-header header-style-1">
            <div class="pbmit-header-overlay">
                <div class="container-fluid">
                    <div class="pbmit-header-content d-flex justify-content-start justify-content-lg-evenly align-items-center">
                            ...
                            <!-- <div class="pbmit-button-box">
                                <div class="pbmit-header-button">
                                    <a href="tel:+91 8080 80 3374">
                                        ...
                                        <span class="pbmit-header-button-text-2">+91 8080 80 3374</span>
                                    </a>
                                </div>
                            </div> -->
            ...
            <div class="enquiry-modal" id="headerEnquiryModal">
                <div class="modal-content">
                    ...
                    <form class="enquiry-form" id="headerEnquiryForm">
                        ...
                        <div class="g-recaptcha" data-sitekey="6LeDZuYsAAAAAE7j-RvrkOXS488u4LzPft0iFkAl"></div>
