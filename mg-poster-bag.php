...
<!-- Title Bar -->
<div class="pbmit-title-bar-wrapper mg">
	<div class="container">
			...
			<div class="pbmit-title-bar-content-inner">
				<div class="pbmit-tbar">
					<div class="pbmit-tbar-inner container">
						...
						<h1 class="pbmit-tbar-title"> MG Poster Bag</h1>
					</div>
				</div>
				<div class="pbmit-breadcrumb">
					<div class="pbmit-breadcrumb-inner">
						...
						<span><span class="post-root post post-post current-item"> MG Poster Bag</span></span>
					</div>
				</div>
			</div>
		</div>
					...
					<div class="pbmit-entry-content">
						<div class="pbmit-service-content">
							<div class="pbmit-heading animation-style2">
								<h3 class="pbmit-title mb-3">MG Poster Bag</h3>
							</div>
							<p class="pbmit-firstletter">
								MG Poster Paper is known for its exceptional brightness and smoothness, making it ideal for high-quality printing and branding. Its strong structure ensures durability even after coating, making it perfect for food packaging and carry bags. Designed for fast food and takeaway applications, it combines performance with presentation.
							</p>
							<p>Premium-finish paper bags for stylish and practical packaging.</p>
						</div>
						<div class="pt-5">
							<div class="pbmit-heading animation-style2">
								...
								<div class="col-md-4">
									<ul class="list-group list-group-borderless">
										<li class="list-group-item">
											...
											<span class="pbmit-icon-list-text">High brightness for premium look</span>
										</li>
										<li class="list-group-item">
											<span class="pbmit-icon-list-icon">
												<i aria-hidden="true" class="pbmit-agrimo-icon pbmit-agrimo-icon-checked"></i>
											</span>
											<span class="pbmit-icon-list-text">Smooth surface for printing</span>
										</li>
										<li class="list-group-item">
											<span class="pbmit-icon-list-icon">
												<i aria-hidden="true" class="pbmit-agrimo-icon pbmit-agrimo-icon-checked"></i>
								...
								<div class="col-md-4">
									<ul class="list-group list-group-borderless">
										...
										<li class="list-group-item">
											...
											<span class="pbmit-icon-list-text">Suitable for branding</span>
										</li>
										<li class="list-group-item">
											<span class="pbmit-icon-list-icon">
												<i aria-hidden="true" class="pbmit-agrimo-icon pbmit-agrimo-icon-checked"></i>
						...
						<div class="pt-5">
							...
							<p>Ideal for businesses prioritizing brand presentation and product quality.</p>
							<div class="row">
								<div class="col-md-4">
									<ul class="list-group list-group-borderless">
										<li class="list-group-item">
						...
						<!-- <div class="pt-5">
							...
							<p>Available in premium formats for branding requirements.</p>
							<div class="row">
								<div class="col-lg-4 mb-4">
									<div class="purchase-option-card">
										<h4>Flat Bag</h4>
										<p>Standard flat bag for various items.</p>
										<button class="pbmit-btn enquire-btn" data-format="Flat Bag">
											<span class="pbmit-button-text">Enquire Now</span>
											<span class="pbmit-button-icon-wrapper">
												<span class="pbmit-button-icon">
													<i class="pbmit-base-icon-black-arrow-1"></i>
								...
								<div class="col-lg-4 mb-4">
									<div class="purchase-option-card">
										<h4>Satchel Bag</h4>
										<p>Expandable bags for larger orders.</p>
										<button class="pbmit-btn enquire-btn" data-format="Satchel Bag">
											<span class="pbmit-button-text">Enquire Now</span>
											<span class="pbmit-button-icon-wrapper">
												<span class="pbmit-button-icon">
													<i class="pbmit-base-icon-black-arrow-1"></i>
								...
								<div class="col-lg-4 mb-4">
									<div class="purchase-option-card">
										<h4>Euro Taper</h4>
										<p>Premium bags with European-style cut.</p>
										<button class="pbmit-btn enquire-btn" data-format="Euro Taper">
											<span class="pbmit-button-text">Enquire Now</span>
											<span class="pbmit-button-icon-wrapper">
												<span class="pbmit-button-icon">
													<i class="pbmit-base-icon-black-arrow-1"></i>
						...
						<div class="pt-5">
							<div class="pbmit-heading animation-style2">
								<h3 class="pbmit-title mb-3">Why Choose MG Poster Bag</h3>
							</div>
							<p>MG Poster Bag from <strong>'Wrap Pack N Carry'</strong> offer excellent print quality and durability, making them perfect for branded packaging. Their smooth finish enhances presentation while maintaining strength and performance. Ideal for modern food businesses, they deliver both style and reliability.</p>
						</div>
					</div>
				</div>
			</div>
		...
		<form class="enquiry-form" id="enquiryForm">
			...
			<div class="form-row product-format-row">
				<div class="form-group form-group-half">
					...
					<input type="text" id="product" name="product" value="MG Poster Bag" readonly>
				</div>
				<div class="form-group form-group-half">
