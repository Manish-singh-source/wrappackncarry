...
<div class="pbmit-slider-area pbmit-slider-one">
	<div class="swiper-slider" data-autoplay='{"delay":5000,"disableOnInteraction":false}' data-loop="true" data-dots="true" data-arrows="false" data-columns="1" data-margin="0" data-effect="fade">
		<div class="swiper-wrapper">
							...
							<div class="col-md-9 col-lg-7">
								<div class="pbmit-slider-content">
									...
									<div class="pbmit-button transform-bottom transform-delay-4">
										<a class="pbmit-btn pbmit-btn-white" href="products">
			...
			<div class="swiper-slide">
				<div class="pbmit-slider-item">
					<div class="pbmit-slider-bg hero-1"></div>
					<div class="container">
						<div class="row g-0">
							<div class="col-md-9 col-lg-7">
								<div class="pbmit-slider-content">
									...
									<div class="pbmit-button transform-bottom transform-delay-4">
										<a class="pbmit-btn pbmit-btn-white" href="oil-grease-resistant-paper">
			...
			<div class="swiper-slide">
				<div class="pbmit-slider-item">
					<div class="pbmit-slider-bg hero-2"></div>
					<div class="container">
						<div class="row g-0">
							<div class="col-md-9 col-lg-7">
								<div class="pbmit-slider-content">
									<h5 class="pbmit-sub-title transform-top transform-delay-1">Smart Packaging Solutions</h5>
									<h2 class="pbmit-title transform-left transform-delay-2">Baking & <br class="br"> Cooking Paper</h2>
									<p class="pbmit-desc transform-left transform-delay-3">Heat resistant, non-stick, oven safe up to ~230°C.</p>
									<div class="pbmit-button transform-bottom transform-delay-4">
										<a class="pbmit-btn pbmit-btn-white" href="baking-and-cooking-paper">
			...
			<div class="swiper-slide">
				<div class="pbmit-slider-item">
					<div class="pbmit-slider-bg hero-3"></div>
					<div class="container">
						<div class="row g-0">
							<div class="col-md-9 col-lg-7">
								<div class="pbmit-slider-content">
									...
									<div class="pbmit-button transform-bottom transform-delay-4">
										<a class="pbmit-btn pbmit-btn-white" href="kraft-paper-bag">
						...
						<div class="row g-0">
							<div class="col-md-9 col-lg-7">
								<div class="pbmit-slider-content">
									...
									<h2 class="pbmit-title transform-left transform-delay-2">Eco-Friendly <br class="br">Tableware</h2>
									...
									<div class="pbmit-button transform-bottom transform-delay-4">
										<a class="pbmit-btn pbmit-btn-white" href="tableware">
						...
						<div class="row g-0">
							<div class="col-md-9 col-lg-7">
								<div class="pbmit-slider-content">
									...
									<h2 class="pbmit-title transform-left transform-delay-2">Pizza <br class="br"> Box</h2>
									...
									<div class="pbmit-button transform-bottom transform-delay-4">
										<a class="pbmit-btn pbmit-btn-white" href="pizza-boxes">
...
<div class="page-content">
						...
						<div class="pbmit-ihbox-box">
							<div class="pbmit-icon-wrapper d-flex align-items-center">
								...
								<div class="pbmit-title-wrap">
									<h2 class="pbmit-element-title">Food-Safe Packaging</h2>
								</div>
							</div>
							<div class="pbmit-content-wrapper">
								<div class="pbmit-heading-desc">Hygienic packaging keeps food fresh and safe.</div>
							</div>
						</div>
					...
					<div class="pbmit-ihbox-style-7 pt-md-0 pt-4">
						<div class="pbmit-ihbox-box">
							<div class="pbmit-icon-wrapper d-flex align-items-center">
								...
								<div class="pbmit-title-wrap">
									<h2 class="pbmit-element-title">Eco-Friendly Materials</h2>
								</div>
							</div>
							<div class="pbmit-content-wrapper">
								<div class="pbmit-heading-desc">Eco-friendly materials reduce environmental impact.</div>
							</div>
						</div>
						<div class="pbmit-ihbox-btn">
							<a href="javascript:void(0);">
					...
					<div class="pbmit-ihbox-style-7 pt-xl-0 pt-4">
						<div class="pbmit-ihbox-box">
							<div class="pbmit-icon-wrapper d-flex align-items-center">
								...
								<div class="pbmit-title-wrap">
									<h2 class="pbmit-element-title">Wide Product Range</h2>
								</div>
							</div>
							<div class="pbmit-content-wrapper">
								<div class="pbmit-heading-desc">Complete packaging solutions for food businesses.</div>
							</div>
						</div>
						<div class="pbmit-ihbox-btn">
							<a href="javascript:void(0);">
					...
					<div class="pbmit-ihbox-style-7 pt-xl-0 pt-4">
						<div class="pbmit-ihbox-box">
							<div class="pbmit-icon-wrapper d-flex align-items-center">
								...
								<div class="pbmit-title-wrap">
									<h2 class="pbmit-element-title">Reliable Supply</h2>
								</div>
							</div>
							<div class="pbmit-content-wrapper">
								<div class="pbmit-heading-desc">Consistent quality with reliable, timely supply.</div>
							</div>
						</div>
						<div class="pbmit-ihbox-btn">
							<a href="javascript:void(0);">
			...
			<div class="row g-0">
								...
								<div class="pbmit-fld-contents">
									<div class="pbmit-fld-wrap">
										...
										<div class="pbmit-fid-sub">
											<div class="pbmit-heading-desc">Businesses Served</div>
										</div>
									</div>
								</div>
				...
				<div class="col-md-12 col-xl-6">
					<div class="who-we-are-one-content">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="pbmit-ihbox-style-4 pe-md-4">
									<div class="pbmit-ihbox-headingicon">
										...
										<div class="pbmit-heading-desc">We use responsible materials and processes that support environmental sustainability.</div>
									</div>
								</div>
							</div>
							<div class="col-md-6">
								<div class="pbmit-ihbox-style-4 ps-md-4">
									<div class="pbmit-ihbox-headingicon">
										<div class="pbmit-ihbox-icon">
											<div class="pbmit-ihbox-icon-wrapper pbmit-icon-type-icon">
	...
	<!-- Service Start -->
	<section class="pbmit-extend-animation section-xl service-bg-one pbmit-bg-color-secondary pbmit-text-color-white">
		<div class="container">
			<div class="position-relative">
				<div class="pbmit-heading-subheading animation-style4">
					<h4 class="pbmit-subtitle">Our Range</h4>
					<h2 class="pbmit-title">Explore Our Product Range</h2>
				</div>
				<div class="service-arrow swiper-btn-custom d-flex flex-row-reverse"></div>
			</div>
					...
					<article class="pbmit-ele-service pbmit-service-style-1 swiper-slide">
						<div class="pbminfotech-post-item">
							<div class="pbminfotech-box-content">
									...
									<div class="pbmit-service-image-wrapper">
										<div class="pbmit-featured-img-wrapper">
											<div class="pbmit-featured-wrapper">
												<img src="images/products/Oil Grease Resistant Paper.webp" class="img-fluid" alt="Oil Grease Resistant Paper">
											</div>
										</div>
									...
									<div class="pbmit-box-content-inner">
										<div class="pbmit-contant-box">
											<div class="pbmit-serv-cat">
												<a href="oil-grease-resistant-paper" rel="tag">Packaging Paper</a>
											</div>
								...
								<a class="pbmit-service-btn" href="oil-grease-resistant-paper" title="Harvest Concepts">
									<span class="pbmit-button-icon-wrapper">
										<span class="pbmit-button-icon">
											<i class="pbmit-base-icon-shopping-cart"></i>
										</span>
							...
							<div class="pbminfotech-box-content">
								<div class="pbmit-box-content-wrap">
									<div class="pbmit-service-image-wrapper">
										<div class="pbmit-featured-img-wrapper">
											<div class="pbmit-featured-wrapper">
												<img src="images/products/Baking & Cooking Paper.webp" class="img-fluid" alt="Baking & Cooking Paper">
											</div>
										</div>
									...
									<div class="pbmit-box-content-inner">
										<div class="pbmit-contant-box">
											<div class="pbmit-serv-cat">
												<a href="baking-and-cooking-paper" rel="tag">Packaging Paper</a>
											</div>
											<h3 class="pbmit-service-title">
								...
								<a class="pbmit-service-btn" href="baking-and-cooking-paper" title="Farming Products">
									<span class="pbmit-button-icon-wrapper">
										<span class="pbmit-button-icon">
											<i class="pbmit-base-icon-shopping-cart"></i>
										</span>
							...
							<div class="pbminfotech-box-content">
								<div class="pbmit-box-content-wrap">
									<div class="pbmit-service-image-wrapper">
										<div class="pbmit-featured-img-wrapper">
											<div class="pbmit-featured-wrapper">
												<img src="images/products/Slip Easy Paper.webp" class="img-fluid" alt="Slip Easy Paper">
											</div>
										</div>
									...
									<div class="pbmit-box-content-inner">
										<div class="pbmit-contant-box">
											<div class="pbmit-serv-cat">
												<a href="slip-easy-paper" rel="tag">Packaging Paper</a>
											</div>
											<h3 class="pbmit-service-title">
							...
							<div class="pbminfotech-box-content">
								<div class="pbmit-box-content-wrap">
									<div class="pbmit-service-image-wrapper">
										<div class="pbmit-featured-img-wrapper">
											<div class="pbmit-featured-wrapper">
												<img src="images/products/Kraft Paper Bag.webp" class="img-fluid" alt="Kraft Paper Bag">
											</div>
										</div>
									...
									<div class="pbmit-box-content-inner">
										<div class="pbmit-contant-box">
											<div class="pbmit-serv-cat">
												<a href="kraft-paper-bag" rel="tag">Packaging Paper</a>
											</div>
											<h3 class="pbmit-service-title">
							...
							<div class="pbminfotech-box-content">
								<div class="pbmit-box-content-wrap">
									<div class="pbmit-service-image-wrapper">
										<div class="pbmit-featured-img-wrapper">
											<div class="pbmit-featured-wrapper">
												<img src="images/products/Tableware.webp" class="img-fluid" alt="Tableware">
											</div>
										</div>
									...
									<div class="pbmit-box-content-inner">
										<div class="pbmit-contant-box">
											<div class="pbmit-serv-cat">
												<a href="tableware" rel="tag">Packaging Paper</a>
											</div>
											<h3 class="pbmit-service-title">
							...
							<div class="pbminfotech-box-content">
								<div class="pbmit-box-content-wrap">
									<div class="pbmit-service-image-wrapper">
										<div class="pbmit-featured-img-wrapper">
											<div class="pbmit-featured-wrapper">
												<img src="images/products/Pizza Boxes.webp" class="img-fluid" alt="Pizza Boxes">
											</div>
										</div>
									...
									<div class="pbmit-box-content-inner">
										<div class="pbmit-contant-box">
											<div class="pbmit-serv-cat">
												<a href="pizza-boxes" rel="tag">Packaging Paper</a>
											</div>
											<h3 class="pbmit-service-title">
							...
							<div class="pbminfotech-box-content">
								<div class="pbmit-box-content-wrap">
									<div class="pbmit-service-image-wrapper">
										<div class="pbmit-featured-img-wrapper">
											<div class="pbmit-featured-wrapper">
												<img src="images/products/Sachet Paper.webp" class="img-fluid" alt="Sachet Paper">
											</div>
										</div>
									...
									<div class="pbmit-box-content-inner">
										<div class="pbmit-contant-box">
											<div class="pbmit-serv-cat">
												<a href="sachet-paper" rel="tag">Packaging Paper</a>
											</div>
											<h3 class="pbmit-service-title">
							...
							<div class="pbminfotech-box-content">
								<div class="pbmit-box-content-wrap">
									<div class="pbmit-service-image-wrapper">
										<div class="pbmit-featured-img-wrapper">
											<div class="pbmit-featured-wrapper">
												<img src="images/products/MG Poster Bag.webp" class="img-fluid" alt="MG Poster Bag">
											</div>
										</div>
									...
									<div class="pbmit-box-content-inner">
										<div class="pbmit-contant-box">
											<div class="pbmit-serv-cat">
												<a href="mg-poster-bag" rel="tag">Packaging Paper</a>
											</div>
											<h3 class="pbmit-service-title">
	...
	<section class="section-xl">
		<div class="container">
			...
			<div class="row align-items-center mt-3">
					...
					<div class="pe-lg-5">
						<div class="pbmit-ihbox-style-12">
							<div class="pbmit-ihbox-box d-flex">
								<div class="pbmit-ihbox-icon">
									<div class="pbmit-ihbox-icon-wrapper pbmit-icon-type-icon">
										<i class="pbmit-agrimo-icon pbmit-agrimo-icon-hand"></i>
									</div>
								</div>
								<div class="pbmit-ihbox-contents">
									<h2 class="pbmit-element-title">Natural Raw Materials</h2>
									<div class="pbmit-heading-desc">Made from sugarcane-based eco-friendly materials</div>
								</div>
							</div>
						</div>
						<div class="pbmit-ihbox-style-12 mt-md-5 mt-4">
							<div class="pbmit-ihbox-box d-flex">
								<div class="pbmit-ihbox-icon">
									<div class="pbmit-ihbox-icon-wrapper pbmit-icon-type-icon">
								...
								<div class="pbmit-ihbox-contents">
									<h2 class="pbmit-element-title">High Quality Packaging</h2>
									<div class="pbmit-heading-desc">Strong, food-safe wrapping designed for durability and everyday use.</div>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="col-md-4">
					<div class="pe-lg-4 mt-md-0 mt-5">
						<div class="pbmit-ihbox-style-12">
							<div class="pbmit-ihbox-box d-flex">
								<div class="pbmit-ihbox-icon">
									<div class="pbmit-ihbox-icon-wrapper pbmit-icon-type-icon">
										<i class="pbmit-agrimo-icon pbmit-agrimo-icon-carrot"></i>
									</div>
								</div>
								<div class="pbmit-ihbox-contents">
									<h2 class="pbmit-element-title">Food-Safe Solutions</h2>
									<div class="pbmit-heading-desc">Keeps your food fresh, hygienic, and ready for takeaway or delivery.</div>
								</div>
							</div>
						</div>
						<div class="pbmit-ihbox-style-12 mt-md-5 mt-4">
							<div class="pbmit-ihbox-box d-flex">
								<div class="pbmit-ihbox-icon">
									<div class="pbmit-ihbox-icon-wrapper pbmit-icon-type-icon">
										<i class="pbmit-agrimo-icon pbmit-agrimo-icon-wheat"></i>
									</div>
								</div>
								<div class="pbmit-ihbox-contents">
									<h2 class="pbmit-element-title">Eco-Friendly Approach</h2>
									<div class="pbmit-heading-desc">Designed to reduce environmental impact without compromising performance.</div>
								</div>
							</div>
						</div>
					</div>
	...
	<section>
		<div class="container-fluid px-4">
			<div class="swiper-slider" data-autoplay='{"delay":"1000"}' data-loop="true" data-dots="false" data-arrows="false" data-columns="4" data-margin="30" data-effect="slide">
				<div class="swiper-wrapper align-items-center">
					...
					<article class="pbmit-portfolio-style-1 swiper-slide">
						<div class="pbminfotech-post-content">
							<div class="pbmit-featured-img-wrapper">
								<div class="pbmit-featured-wrapper">
									<img src="images/portfolio-image/1.webp" class="img-fluid" alt="Portfolio Image">
								</div>
							</div>
							<div class="pbminfotech-box-content">
					...
					<article class="pbmit-portfolio-style-1 swiper-slide">
						<div class="pbminfotech-post-content">
							<div class="pbmit-featured-img-wrapper">
								<div class="pbmit-featured-wrapper">
									<img src="images/portfolio-image/2.webp" class="img-fluid" alt="Portfolio Image">
								</div>
							</div>
							<div class="pbminfotech-box-content">
								<div class="pbminfotech-titlebox">
					...
					<article class="pbmit-portfolio-style-1 swiper-slide">
						<div class="pbminfotech-post-content">
							<div class="pbmit-featured-img-wrapper">
								<div class="pbmit-featured-wrapper">
									<img src="images/portfolio-image/3.webp" class="img-fluid" alt="Portfolio Image">
								</div>
							</div>
							<div class="pbminfotech-box-content">
								<div class="pbminfotech-titlebox">
					...
					<article class="pbmit-portfolio-style-1 swiper-slide">
						<div class="pbminfotech-post-content">
							<div class="pbmit-featured-img-wrapper">
								<div class="pbmit-featured-wrapper">
									<img src="images/portfolio-image/4.webp" class="img-fluid" alt="Portfolio Image">
								</div>
							</div>
							<div class="pbminfotech-box-content">
								<div class="pbminfotech-titlebox">
					...
					<article class="pbmit-portfolio-style-1 swiper-slide">
						<div class="pbminfotech-post-content">
							<div class="pbmit-featured-img-wrapper">
								<div class="pbmit-featured-wrapper">
									<img src="images/portfolio-image/5.webp" class="img-fluid" alt="Portfolio Image">
								</div>
							</div>
							<div class="pbminfotech-box-content">
								<div class="pbminfotech-titlebox">
					...
					<article class="pbmit-portfolio-style-1 swiper-slide">
						<div class="pbminfotech-post-content">
							<div class="pbmit-featured-img-wrapper">
								<div class="pbmit-featured-wrapper">
									<img src="images/portfolio-image/8.webp" class="img-fluid" alt="Portfolio Image">
								</div>
							</div>
							<div class="pbminfotech-box-content">
								<div class="pbminfotech-titlebox">
					...
					<article class="pbmit-portfolio-style-1 swiper-slide">
						<div class="pbminfotech-post-content">
							<div class="pbmit-featured-img-wrapper">
								<div class="pbmit-featured-wrapper">
									<img src="images/portfolio-image/9.webp" class="img-fluid" alt="Portfolio Image">
								</div>
							</div>
							<div class="pbminfotech-box-content">
								<div class="pbminfotech-titlebox">
					...
					<article class="pbmit-portfolio-style-1 swiper-slide">
						<div class="pbminfotech-post-content">
							<div class="pbmit-featured-img-wrapper">
								<div class="pbmit-featured-wrapper">
									<img src="images/portfolio-image/10.webp" class="img-fluid" alt="Portfolio Image">
								</div>
							</div>
							<div class="pbminfotech-box-content">
								<div class="pbminfotech-titlebox">
	...
	<!-- <section class="section-xl">
		<div class="container">
			...
			<div class="swiper-slider" data-autoplay="true" data-arrows-class="testimonial-arrow" data-loop="true" data-dots="false" data-arrows="true" data-columns="3" data-margin="30" data-effect="slide">
				<div class="swiper-wrapper">
							...
							<div class="pbmit-box-content-wrap">
								...
								<div class="pbminfotech-box-author d-flex align-items-center">
									...
									<div class="pbmit-auther-content">
										...
										<div class="pbminfotech-testimonial-detail">Worker</div>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="pbmit-box-content-wrap">
								...
								<div class="pbminfotech-box-author d-flex align-items-center">
									<div class="pbminfotech-box-img">
										<div class="pbmit-featured-img-wrapper">
											<div class="pbmit-featured-wrapper">
												<img src="images/homepage-1/testimonial/testimonial-02.jpg" class="img-fluid" alt="">
											</div>
										</div>
									</div>
									<div class="pbmit-auther-content">
							...
							<div class="pbmit-box-content-wrap">
								...
								<div class="pbminfotech-box-author d-flex align-items-center">
									<div class="pbminfotech-box-img">
										<div class="pbmit-featured-img-wrapper">
											<div class="pbmit-featured-wrapper">
												<img src="images/homepage-1/testimonial/testimonial-03.jpg" class="img-fluid" alt="">
											</div>
										</div>
									</div>
									<div class="pbmit-auther-content">
							...
							<div class="pbmit-box-content-wrap">
								...
								<div class="pbminfotech-box-author d-flex align-items-center">
									<div class="pbminfotech-box-img">
										<div class="pbmit-featured-img-wrapper">
											<div class="pbmit-featured-wrapper">
												<img src="images/homepage-1/testimonial/testimonial-04.jpg" class="img-fluid" alt="">
											</div>
										</div>
									</div>
									<div class="pbmit-auther-content">
							...
							<div class="col-md-12 col-xl-6">
								<div class="about-us-one-rightbox">
									<div class="pbmit-heading-subheading animation-style4">
										...
										<h2 class="pbmit-title">Healthy life with fresh products</h2>
										<div class="pbmit-heading-desc">
									...
									<div class="row">
										<div class="col-md-6">
											<div class="pbminfotech-ele-fid-style-3">
												<div class="pbmit-fld-contents d-flex align-items-center">
													<div class="pbmit-circle-outer" data-digit="90" data-fill="#ffffff" data-emptyfill="" data-before="" data-after="<sup>%</sup>" data-thickness="3" data-size="127">
													...
													<div class="pbmit-fid-sub">
														<h3 class="pbmit-fid-title">Eco Farms Worldwide</h3>
													</div>
												</div>
											</div>
										</div>
										<div class="col-md-6 mt-md-0 mt-3">
											<div class="pbminfotech-ele-fid-style-3">
												<div class="pbmit-fld-contents d-flex align-items-center">
													<div class="pbmit-circle-outer" data-digit="78" data-fill="#ffffff" data-emptyfill="" data-before="" data-after="<sup>%</sup>" data-thickness="3" data-size="127">
														<div class="pbmit-circle">
															<div class="pbmit-fid-inner">
																<span class="pbmit-fid-before"></span>
																<span class="pbmit-number-rotate numinate" data-appear-animation="animateDigits" data-from="0" data-to="78" data-interval="5" data-before="" data-before-style="" data-after="" data-after-style="">78</span>
																<span class="pbmit-fid"><sup>%</sup></span>
															</div>
														</div>
													</div>
													<div class="pbmit-fid-sub">
														<h3 class="pbmit-fid-title">Special Equipment</h3>
													</div>
												</div>
											</div>
										</div>
	...
	<!-- Our History Start -->
	<!-- <section class="section-xl pbmit-element-miconheading-style-9"> 
				<div class="container">
					<div class="pbmit-heading-subheading pbmit-heading-subheading-style-2 animation-style4">
						<div class="pbmit-hs-left">
							<h4 class="pbmit-subtitle">Our History</h4>
							<h2 class="pbmit-title">Farming have been since 1866</h2>
						</div>
						<div class="pbmit-hs-right">
							<div class="pbmit-heading-desc">
								There are many variations of passages of Lorem Ipsum available, but the majority <br> have suffered alteration in some form, by injected humour, or randomised words <br> which don't look even.
							</div>
						</div>
					</div>
							...
							<div class="swiper-wrapper">
								<article class="pbmit-miconheading-style-9 swiper-slide">
									<div class="pbmit-ihbox-style-9">
										<div class="pbmit-ihbox-headingicon">
											<div class="pbmit-ihbox-icon">
												<div class="pbmit-ihbox-icon-wrapper pbmit-ihbox-icon-type-text">1987</div>
											</div>
											<div class="pbmit-ihbox-contents">
								...
								<article class="pbmit-miconheading-style-9 swiper-slide">
									<div class="pbmit-ihbox-style-9">
										<div class="pbmit-ihbox-headingicon">
											<div class="pbmit-ihbox-icon">
												<div class="pbmit-ihbox-icon-wrapper pbmit-ihbox-icon-type-text">1995</div>
											</div>
											<div class="pbmit-ihbox-contents">
												<h2 class="pbmit-element-title">
													Farm Remodelacion
												</h2>
												<div class="pbmit-heading-desc">Majority have suffered alteration in some form by injected humor culpa odio temporibus.</div>
											</div>
										</div>
									</div>
								</article>
								<article class="pbmit-miconheading-style-9 swiper-slide">
									<div class="pbmit-ihbox-style-9">
										<div class="pbmit-ihbox-headingicon">
											<div class="pbmit-ihbox-icon">
												<div class="pbmit-ihbox-icon-wrapper pbmit-ihbox-icon-type-text">2000</div>
											</div>
											<div class="pbmit-ihbox-contents">
												<h2 class="pbmit-element-title">
													Grainfarmers Formed
												</h2>
												<div class="pbmit-heading-desc">Always parties but trying she shewing of moment minus Velit ratione hic corporis veritatis odit.</div>
											</div>
										</div>
									</div>
								</article>
								<article class="pbmit-miconheading-style-9 swiper-slide">
									<div class="pbmit-ihbox-style-9">
										<div class="pbmit-ihbox-headingicon">
											<div class="pbmit-ihbox-icon">
												<div class="pbmit-ihbox-icon-wrapper pbmit-ihbox-icon-type-text">1910</div>
											</div>
											<div class="pbmit-ihbox-contents">
												<h2 class="pbmit-element-title">
													Start of Agriculture
												</h2>
												<div class="pbmit-heading-desc">Consequatur magni Corrupti ut  minus! Iusto eos consectetur similique minus culpa odio temporibus.</div>
											</div>
										</div>
									</div>
								</article>
	...
	<!-- Blog Start -->
	<!-- <section class="section-xl pbmit-column-three">
				<div class="container">
					<div class="position-relative">
						<div class="pbmit-heading-subheading animation-style4">
						...
						<div class="blog-arrow swiper-btn-custom d-flex flex-row-reverse"></div>
					</div>
					<div class="swiper-slider" data-autoplay="false" data-arrows-class="blog-arrow" data-loop="true" data-dots="false" data-arrows="true" data-columns="3" data-margin="30" data-effect="slide">
						<div class="swiper-wrapper">
								...
								<div class="post-item">
									<div class="pbminfotech-box-content">
										<div class="pbmit-featured-container">
											<div class="pbmit-featured-img-wrapper">
												<div class="pbmit-featured-wrapper">
													<img src="images/homepage-1/blog/blog-image-01.jpg" class="img-fluid" alt="">
												</div>
											</div>
											...
											<div class="pbmit-meta-cat-wrapper pbmit-meta-line">
												<div class="pbmit-meta-category">
													<a href="blog-classic.html" rel="category tag">Food Crops</a>
												</div>
											</div>
											...
											<div class="pbmit-meta-date-wrapper pbmit-meta-line">
												<div class="pbmit-meta-date">
													<span class="pbmit-post-date">
														<i class="pbmit-base-icon-calendar-3"></i>March  28. 2024
													</span>
												</div>
											</div>
										...
										<div class="pbmit-content-wrapper">
											<h3 class="pbmit-post-title">
												<a href="blog-details.html">What technology is used in vertical farming?</a>
											</h3>
										</div>
									</div>
								</div>
								...
								<div class="post-item">
									<div class="pbminfotech-box-content">
										<div class="pbmit-featured-container">
											<div class="pbmit-featured-img-wrapper">
												<div class="pbmit-featured-wrapper">
													<img src="images/homepage-1/blog/blog-image-02.jpg" class="img-fluid" alt="">
												</div>
											</div>
											<a class="pbmit-blog-btn" href="blog-details.html">
												<span class="pbmit-button-icon-wrapper">
											...
											<div class="pbmit-meta-cat-wrapper pbmit-meta-line">
												<div class="pbmit-meta-category">
													<a href="blog-classic.html" rel="category tag">Organic Farm</a>
												</div>
											</div>
											<a class="pbmit-link" href="blog-details.html"></a>
										</div>
										...
										<div class="pbmit-content-wrapper">
											<h3 class="pbmit-post-title">
												<a href="blog-details.html">Which type of farming is more prevalent today?</a>
											</h3>
										</div>
									</div>
								</div>
								...
								<div class="post-item">
									<div class="pbminfotech-box-content">
										<div class="pbmit-featured-container">
											<div class="pbmit-featured-img-wrapper">
												<div class="pbmit-featured-wrapper">
													<img src="images/homepage-1/blog/blog-image-03.jpg" class="img-fluid" alt="">
												</div>
											</div>
											<a class="pbmit-blog-btn" href="blog-details.html">
												<span class="pbmit-button-icon-wrapper">
											...
											<div class="pbmit-meta-cat-wrapper pbmit-meta-line">
												<div class="pbmit-meta-category">
													<a href="blog-classic.html" rel="category tag">Farming Tips</a>
												</div>
											</div>
											<a class="pbmit-link" href="blog-details.html"></a>
										</div>
										...
										<div class="pbmit-content-wrapper">
											<h3 class="pbmit-post-title">
												<a href="blog-details.html">The Farmers Sentiment Darkens Hopes Fade</a>
											</h3>
										</div>
									</div>
								</div>
								...
								<div class="post-item">
									<div class="pbminfotech-box-content">
										<div class="pbmit-featured-container">
											<div class="pbmit-featured-img-wrapper">
												<div class="pbmit-featured-wrapper">
													<img src="images/homepage-1/blog/blog-image-04.jpg" class="img-fluid" alt="">
												</div>
											</div>
											<a class="pbmit-blog-btn" href="blog-details.html">
												<span class="pbmit-button-icon-wrapper">
											...
											<div class="pbmit-meta-cat-wrapper pbmit-meta-line">
												<div class="pbmit-meta-category">
													<a href="blog-classic.html" rel="category tag">Mixed Farming</a>
												</div>
											</div>
											<a class="pbmit-link" href="blog-details.html"></a>
										</div>
										...
										<div class="pbmit-content-wrapper">
											<h3 class="pbmit-post-title">
												<a href="blog-details.html">A farmer is a person who works in agriculture.</a>
											</h3>
										</div>
									</div>
								</div>
								...
								<div class="post-item">
									<div class="pbminfotech-box-content">
										<div class="pbmit-featured-container">
											<div class="pbmit-featured-img-wrapper">
												<div class="pbmit-featured-wrapper">
													<img src="images/homepage-1/blog/blog-image-05.jpg" class="img-fluid" alt="">
												</div>
											</div>
											<a class="pbmit-blog-btn" href="blog-details.html">
												<span class="pbmit-button-icon-wrapper">
											...
											<div class="pbmit-meta-cat-wrapper pbmit-meta-line">
												<div class="pbmit-meta-category">
													<a href="blog-classic.html" rel="category tag">Agriculture</a>
												</div>
											</div>
											<a class="pbmit-link" href="blog-details.html"></a>
										</div>
										...
										<div class="pbmit-content-wrapper">
											<h3 class="pbmit-post-title">
												<a href="blog-details.html">Organic Fruits: Hidden Advantages And Information</a>
											</h3>
										</div>
									</div>
								</div>
								...
								<div class="post-item">
									<div class="pbminfotech-box-content">
										<div class="pbmit-featured-container">
											<div class="pbmit-featured-img-wrapper">
												<div class="pbmit-featured-wrapper">
													<img src="images/homepage-1/blog/blog-image-06.jpg" class="img-fluid" alt="">
												</div>
											</div>
											<a class="pbmit-blog-btn" href="blog-details.html">
												<span class="pbmit-button-icon-wrapper">
											...
											<div class="pbmit-meta-cat-wrapper pbmit-meta-line">
												<div class="pbmit-meta-category">
													<a href="blog-classic.html" rel="category tag">Extensive</a>
												</div>
											</div>
											<a class="pbmit-link" href="blog-details.html"></a>
										</div>
										...
										<div class="pbmit-content-wrapper">
											<h3 class="pbmit-post-title">
												<a href="blog-details.html">How to Include Organic Vegetables in Your Diet</a>
											</h3>
										</div>
									</div>
								</div>
